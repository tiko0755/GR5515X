...
{
    int                        s_product_type;
    data_produce_func          s_data_produce_func;
    data_free_func             s_data_free_func;
    data_consume_func          s_data_consume_func;
    data_error_func            s_data_error_func;
    data_on_ble_evt_func       s_data_on_ble_evt_func;
    data_init_func             s_data_init_func;
    data_main_process_func     s_data_main_process_func;
    data_button_handler_func   s_data_button_handler_func;
    void                      *s_data_produce_args;
