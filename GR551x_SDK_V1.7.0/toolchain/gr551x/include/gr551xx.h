...
typedef struct _iso7816_regs
{
    ...
    __IM  uint32_t ADDR;                      /**< Address Register ,                      Address offset: 0x0018 */
...
#define AON_RF_REG_0_RCOSC_BIAS_CNTRL_Msk                   (0x03 << AON_RF_REG_0_RCOSC_BIAS_CNTRL_Pos)
...
#define I2C_TX_ABRT_SRC_TX_FLUSH_CNT_Msk                    (0x1FFU << I2C_TX_ABRT_SRC_TX_FLUSH_CNT_Pos)
