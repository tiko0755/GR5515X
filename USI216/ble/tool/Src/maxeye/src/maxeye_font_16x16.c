 ...
 *****************************************************************************************
 */
const uint8_t s_ascii_font8_16[][16] = {
    ...
    {0x30,0x4C,0x43,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"~",92*/
};
...
void maxeye_put_one_gb2312(uint16_t x, uint16_t y, const uint8_t(*pGb2312)[16], uint16_t index)
{
    ...
    for(i=0; i<16; i++)
    {  
        gui_point_color(x, y, pGb2312[index*2][i], 8);
        gui_point_color(x+8, y, pGb2312[index*2+1][i], 8);
        y++;                                                        
    }
}
...
void maxeye_put_gb2312_string(uint16_t x, uint16_t y, const uint8_t(*pGb2312)[16], uint16_t num)
{
    ...
    for(i=0; i<num; i++)
    {
        maxeye_put_one_gb2312(x, y, pGb2312, i);
        x += 16;
    }
}
...
{  
    ...
    for(i=0; i<16; i++)
    {  
        gui_point_color(x, y,s_ascii_font8_16[ch][i], 8);
        y++;                                                                    
    }
...
{  
    ...
    { 
        if( (*p_str)=='\0' ) break;
        if( maxeye_put_char8_16(x, y, *p_str++)==0 ) break; 
        x += 8;                            
    }
}
