...
static void svr1chr0_res(s32 rslt, void* argv);
static void svr2chr0_res(s32 rslt, void* argv);
...
static void svr3chr0_res(s32 rslt, void* argv);
...
static int32_t svrChr_req_common(char *svr_chr, int32_t* x, uint8_t len){
    ...
    if(strncmp(svr_chr, "svr1chr0", strlen("svr1chr0"))==0)     {    proc_svr1chr0_req(xCmd, 8, svr1chr0_res, 5000); }
    else if(strncmp(svr_chr, "svr1chr0", strlen("svr1chr0"))==0){    proc_svr1chr0_req(xCmd, len, svr1chr0_res, 5000); }
    else if(strncmp(svr_chr, "svr2chr0", strlen("svr2chr0"))==0){    proc_svr2chr0_req(xCmd, len, svr2chr0_res, 5000); }
    ...
    else if(strncmp(svr_chr, "svr3chr0", strlen("svr3chr0"))==0){    proc_svr3chr0_req(xCmd, len, svr3chr0_res, 5000); }
    else{   return -1;  }
    return 0;
}   
...
static void svr1chr0_res(s32 rslt, void* argv){ svrChr_res("svr1chr0", rslt, argv); }
static void svr2chr0_res(s32 rslt, void* argv){ svrChr_res("svr2chr0", rslt, argv); }
...
static void svr3chr0_res(s32 rslt, void* argv){ svrChr_res("svr3chr0", rslt, argv); }
